...
import com.lab.vxt.heywake.ui.fragments.MoreSettingFragment;
import com.lab.vxt.heywake.ui.fragments.NewsFragment;
...
public class HomeActivity extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayoutHome = (TabLayout) findViewById(R.id.tabs);
        tabLayoutHome.setupWithViewPager(mViewPager);
        for (int i= 0; i< tabLayoutHome.getTabCount(); i++){
            tabLayoutHome.getTabAt(i).setIcon(icons[i]);
        }
